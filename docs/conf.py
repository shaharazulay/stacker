...
Read our documentation on safer password practices. See our blog for more details.
 Unwatch 1
 Star 0  Fork 7 shaharazulay/stacker
forked from atavory/stacker
 Code  Pull requests 0  Projects 0  Wiki  Insights  Settings
Branch: master Find file Copy path stacker/docs/conf.py
3987e1b  on Aug 3, 2017
@atavory atavory minor docs
1 contributor
RawBlameHistory    
317 lines (239 sloc)  9.88 KB
# -*- coding: utf-8 -*-
#
...
project = u'stacker'
copyright = u'2018, Shahar Azulay, Ariel Hanemann'
author = u'Shahar Azulay, Ariel Hanemann'
...
latex_documents = [
    (master_doc, 'stacke.tex', u'Stacke',
